/*
Full Time and Above with Institutional Loans — Summer
...
PURPOSE
  ...
  term whose enrolled credit hours meet or exceed the Mines Summer
  full-time threshold.

BUSINESS RULES
  * TARGET_TERM is a required Insights text parameter such as 202655.
  * Undergraduate students are included at 12 or more credits.
  * Graduate students are included at 9 or more credits.
  * These are the Mines Summer full-time thresholds.
