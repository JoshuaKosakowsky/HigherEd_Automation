/*
All Enrollment Load Categories with Institutional Loans — Summer
...
PURPOSE
  ...
  term, categorized across all Mines Summer enrollment-load ranges.

BUSINESS RULES
  * TARGET_TERM is a required Insights text parameter such as 202655.
  * Undergraduate bands are below 6, 6 through below 12, and 12 or more.
  * Graduate bands are below 4.5, 4.5 through below 9, and 9 or more.
  * Every UG/GR loan recipient is retained in exactly one enrollment band.
...
report_rows AS (
    SELECT
        ...
        CASE
            ...
            WHEN student.student_level = 'GR'
                THEN 'Full Time and Above'
        END AS enrollment_load_category,
