/*
Less Than Half Time with Institutional Loans
...
PURPOSE
  ...
  term whose enrolled credit hours are below the Mines half-time threshold.

BUSINESS RULES
  * TARGET_TERM is a required Insights text parameter such as 202655.
  * Undergraduate students are below half time at fewer than 6 credits.
  * Graduate students are below half time at fewer than 4.5 credits.
