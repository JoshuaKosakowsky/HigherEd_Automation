...
$WorkflowName = "BM_REFUND_PREFERENCE"
$TargetName   = "BankMobile"
$MutexName    = "BM_REFUND_PREFERENCE_MUTEX"

$PythonExe = Join-Path $ProjectRoot ".venv\Scripts\python.exe"
$PyScript  = Join-Path $ProjectRoot "workflows\refund_preference\run_refund_preference.py"
$LogDir    = Join-Path $ProjectRoot "logs\bankmobile\refund_preference"
