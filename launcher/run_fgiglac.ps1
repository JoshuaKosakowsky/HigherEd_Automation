...
$WorkflowName     = "FGIGLAC"
$TargetName = "Banner"
$MutexName        = "FGIGLAC_MUTEX"

$PythonExe = Join-Path $ProjectRoot ".venv\Scripts\python.exe"
$PyScript  = Join-Path $ProjectRoot "workflows\fgiglac\run_fgiglac.py"
$LogDir    = Join-Path $ProjectRoot "logs\banner\fgiglac"
