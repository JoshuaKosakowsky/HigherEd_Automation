...
$WorkflowName = "BM_TIMEOUT_REVERSAL"
$TargetName   = "BankMobile"
$MutexName    = "BM_TIMEOUT_REVERSAL_MUTEX"

$PythonExe = Join-Path $ProjectRoot ".venv\Scripts\python.exe"
$PyScript  = Join-Path $ProjectRoot "workflows\timeout_reversal\run_timeout_reversal.py"
$LogDir    = Join-Path $ProjectRoot "logs\bankmobile\timeout_reversal"
